...
from .views import FriendsView, ProfileFriend, SearchViewPerson, SearchViewFriends, RequestList, RequestSend, RequestAccepted, RequestRemove, DeleteFriend, BlockUser, BlockList
